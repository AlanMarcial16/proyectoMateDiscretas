...
def dibujar_camino(nodo1, nodo2, peso):
    ...
    if fila1 == fila2:
        ax.plot([x1, x2], [y1, y1], color="red", linewidth=2, zorder=2)
    elif col1 == col2:
        ax.plot([x1, x1], [y1, y2], color="red", linewidth=2, zorder=2)
    else:
        ax.plot([x1, x1], [y1, y2], color="red", linewidth=2, zorder=2)
        ax.plot([x1, x2], [y2, y2], color="red", linewidth=2, zorder=2)
